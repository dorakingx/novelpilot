...
import type { Language, LengthUnit, PartPlan } from "@/lib/types";
...
export function ChapterLengthPlanList({
  ...
  const unit: LengthUnit = language === "ja" ? "characters" : "words";
  ...
  return (
    <div className="space-y-3">
      <div>
        <h4 className="text-sm font-semibold text-[#F8FAFC]">Approximate length</h4>
        {!advancedMode && (
          <p className="text-xs text-[#94A3B8] mt-0.5">
            Set approximate length per chapter for pacing guidance.
          </p>
        )}
      </div>
              ...
              return (
                ...
                >
                  <span className="text-xs font-medium text-[#F5C542]">
                    Chapter {ch.number} — approximate length
                  </span>
